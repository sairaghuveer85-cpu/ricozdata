...
export default function Badge({
  ...
  if (status) {
    switch (status) {
      ...
      case 'Resolved':
      case 'Compliant':
        styleClasses = 'bg-emerald-50 dark:bg-emerald-950/40 text-emerald-700 dark:text-emerald-400 border-emerald-200 dark:border-emerald-800/60';
      ...
      case 'Warning':
      case 'Medium':
        styleClasses = 'bg-amber-50 dark:bg-amber-950/40 text-amber-700 dark:text-amber-400 border-amber-200 dark:border-amber-800/60';
        dotColor = 'bg-amber-500';
        break;
      case 'Open':
      case 'High':
      case 'Danger':
        styleClasses = 'bg-rose-50 dark:bg-rose-950/40 text-rose-700 dark:text-rose-400 border-rose-200 dark:border-rose-800/60';
        dotColor = 'bg-rose-500';
        break;
      case 'Low':
        styleClasses = 'bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-700';
    ...
    const variants = {
      ...
      primary: 'bg-blue-50 dark:bg-blue-950/40 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-800/60',
      ...
      tag: 'bg-blue-50 dark:bg-blue-950/30 text-blue-700 dark:text-blue-300 border-blue-100 dark:border-blue-900/50 rounded-md font-normal'
    };
