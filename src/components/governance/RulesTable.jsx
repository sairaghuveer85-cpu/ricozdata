...
export default function RulesTable({ activeSubTab }) {
  if (activeSubTab === 'rules') {
    return (
      <div className="bg-white dark:bg-[#0B1628] rounded-xl border border-slate-200 dark:border-slate-800 shadow-2xs overflow-hidden">
  ...
  if (activeSubTab === 'access') {
    return (
      <div className="bg-white dark:bg-[#0B1628] rounded-xl p-6 border border-slate-200 dark:border-slate-800 shadow-2xs space-y-4">
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-slate-50/80 dark:bg-[#111C2E] border-b border-slate-200 dark:border-slate-800 text-left font-bold text-slate-600 dark:text-slate-300">
                ...
                <th className="py-3 px-4 text-center">Manage Policies</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800/60">
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
      {COMPLIANCE_FRAMEWORKS.map((fw, idx) => (
        <div
          key={idx}
          className="bg-white dark:bg-[#0B1628] rounded-xl p-5 border border-slate-200 dark:border-slate-800 shadow-2xs hover:shadow-md transition-all flex flex-col justify-between"
        >
          <div>
